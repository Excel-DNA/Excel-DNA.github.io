    ...
    <section className={styles.features}>
      <div className="container">
        <div className="intro-content">
          ...
          <h3>Distribution</h3>
          <p>In order to use the newly created add-in, users would require the .NET 10 Desktop Runtime to be installed. Additionally, the correct architecture (32bit or 64bit) of the installation should be taken into consideration.</p>
        </div>
        <hr />
        <div>
